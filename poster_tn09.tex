...
\title{Mise en \oe{}uvre d'une plateforme d'intégration continue pour un logiciel spatial\\
  \Large{TN09}
}
\author{Guillaume \textsc{Jorandon}\\
  Centre CEA de Paris-Saclay — Institut de recherche sur les lois fondamentales de l'univers\\
}
...
\begin{tikzpicture}
  ...
  \addlogo[north west]{(-14,-\blocktitleheight)}{12cm}{logo_utc}
